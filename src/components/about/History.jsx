...
const History = () => {
  return (
    <section id="about" className="bg-gray-100 py-10 md:py-32 ">
      <div className=" flex flex-col md:flex-row justify-around gap-8 md:gap-0 items-center ">
        <div className="flex flex-col items-center px-4 ">
          <h2 className="md:text-3xl text-2xl font-semibold mb-4">Our History</h2>
          <div className="max-w-lg mx-auto">
            ...
            <p className="mt-4 md:text-lg text-base text-gray-700 text-center">
